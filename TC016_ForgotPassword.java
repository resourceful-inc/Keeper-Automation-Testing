...
public class TC016_ForgotPassword {

	public static void main(String[] args) {
		//Test Case 016
		//Summary: Verifying email with non-existing email 
		//Expected Result: It will raise error message "This is not a registered email"
		...
		driver.findElement(By.xpath("//*[@id='email']")).sendKeys("sfoiwef@fiowf.foijwefoij");
